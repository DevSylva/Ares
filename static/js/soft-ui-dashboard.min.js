...
function navbarBlurOnScroll(e) {
  ...
  window.onscroll = debounce(
    "true" == e
      ? function () {
          5 < window.scrollY
            ? (t.classList.add(...n), t.classList.remove(...i), l("blur"))
            : a();
        }
      : function () {
          a();
          ...
          function () {
            ...
            if (l.classList.contains("flex-column")) {
              ...
              (s.style.transform = "translate3d(" + e + "px, 0px, 0px)"),
                (s.style.width =
                  l.querySelector("li:nth-child(" + i + ")").offsetWidth +
                  "px");
            }
          };
      }
      ...
      if (l) {
        ...
        if (n.classList.contains("flex-column")) {
          for (var s = 1; s <= e.indexOf(l); s++)
            t += n.querySelector("li:nth-child(" + s + ")").offsetHeight;
          ...
          for (s = 1; s <= e.indexOf(l); s++)
            t += n.querySelector("li:nth-child(" + s + ")").offsetWidth;
